...
export const MainBodyRU = (props) => {
  return (
    <div className="main-body">
      Растения не только лечат, но и прекрасны на вкус. За ними<br/>
      будущее! Недаром же весь мир следует принципам здорового<br/>
      питания, чтобы быть в гармонии с собой и планетой.<br/>
      Но мы предлагаем не ещё один салат, свежие овощи или фруктовые<br/>
      соки. В «Ідеаль Немолоко» есть то, что изменит твоё представление о<br/>
      молоке. Потому что это НЕмолоко.
      <br/><br/>
      Компания «Люстдорф» первой подхватила мировую тенденцию и<br/>
      создала долгожданный 100% украинский, натуральный<br/>
      растительный напиток.<br/>
      Это вкусно, доступно и с заботой о здоровье страны.<br/>
      «Ідеаль Немолоко» изменит твоё представление о здоровом питании,<br/>
...
export const WhySlide3BodyRU = (props) => (
  <div className="why-body">
    ...
    <div className={props.index === 3 ? 'why-body-description why-body-description-active' : 'why-body-description'}>
      ...
      (центральный офис в Швейцарии) подтверждает,
