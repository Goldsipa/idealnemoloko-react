...
export const MainBodyUA = (props) => {
  return (
    <div className="main-body">
      Рослини не тільки лікують, а й добре смакують. За ними майбутнє! Недарма 
      ж увесь світ наслідує принципи здорового харчування, щоб бути у гармонії 
...
export const MainBodyRU = (props) => {
  return (
    <div className="main-body">
      Растения не только лечат, но и прекрасны на вкус. За ними
      будущее! Недаром же весь мир следует принципам здорового
