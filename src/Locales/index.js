...
export const WhySlideBodyUA = (props) => (
  <div className="why-body">
    ...
    <div className={props.index === 0 ? 'why-body-description why-body-description-active' : 'why-body-description'}>
      ...
      <p>Ми турбуємося про наших споживачів:</p>
      <div className='why-body-list'>
        <table>
          <tbody>
            <tr>
              <td>-</td>
              <td>про тих, хто любить змінювати смаки та експериментувати</td>
            </tr>
            <tr>
              <td>-</td>
              <td>про тих, хто не може пити коров’яче молоко</td>
            </tr>
            <tr>
              <td>-</td>
              <td>про тих, хто просто любить смачненьке</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export const WhySlideBodyRU = (props) => (
  <div className="why-body">
    ...
    <div className={props.index === 0 ? 'why-body-description why-body-description-active' : 'why-body-description'}>
      ...
      <p>Мы заботимся о наших потребителях:</p>
      <div className='why-body-list'>
        <table>
          <tbody>
            <tr>
              <td>-</td>
              <td>о тех, кто любит менять вкусы и экспериментировать</td>
            </tr>
            <tr>
              <td>-</td>
              <td>о тех, кто не может пить коровье молоко</td>
            </tr>
            <tr>
              <td>-</td>
              <td>о тех, кто просто любит вкусное</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export const WhySlide1BodyUA = (props) => (
  <div className="why-body">
    <div className={props.index === 1 ? 'why-body-description why-body-description-active' : 'why-body-description'}>
      ...
      <p className="whySlide-1-li">- для тих, хто любить пробувати нове</p>
      <p className="whySlide-1-li">- для тих, хто дотримується посту</p>
      <p className="whySlide-1-li">- для веганів, вегетаріанців</p>
      <p className="whySlide-1-li">
        - для тих, хто не переносить лактози або має алергію
        на білок коров&#39;ячого молока.
      </p>
      <br/>
      <p>
        Для пікніка і домашнього затишку, до чаю, кави і просто так,
...
export const WhySlide1BodyRU = (props) => (
  <div className="why-body">
    <div className={props.index === 1 ? 'why-body-description why-body-description-active' : 'why-body-description'}>
      ...
      <p className="whySlide-1-li">- для тех, кто любит пробовать новое</p>
      <p className="whySlide-1-li">- для тех, кто придерживается поста</p>
      <p className="whySlide-1-li">- для веганов, вегетарианцев</p>
      <p className="whySlide-1-li">
        - для тех, кто не переносит лактозу или имеет 
        аллергию на белок коровьего молока.
      </p>
      <br/>
      <p>
  ...
  <div className="why-body">
    <div className={props.index === 2 ? 'why-body-description why-body-description-active' : 'why-body-description'}>
      ...
      <p><b>
        ...
        холестерину, ГМО та доданого цукру. 
      </b></p><br/>
      <p>
